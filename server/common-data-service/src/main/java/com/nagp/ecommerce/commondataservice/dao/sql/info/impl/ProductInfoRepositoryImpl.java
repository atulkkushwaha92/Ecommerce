package com.nagp.ecommerce.commondataservice.dao.sql.info.impl;

import com.nagp.ecommerce.commondataservice.dao.sql.info.queryhelpers.ProductQueryHelper;
import com.nagp.ecommerce.commondataservice.dao.sql.info.queryhelpers.context.ParamsToQueryContext;
...
import com.nagp.ecommerce.commondataservice.utils.resulttransformers.ListResultTransformer;
...
public class ProductInfoRepositoryImpl {
    ...
    public HomeTabsDataResponse getBrandsAndApparelsByGender() {
        ...
        homeTabsDataResponse.setMen(getBrandsAndApparelsList(1));
        homeTabsDataResponse.setWomen(getBrandsAndApparelsList(2));
