...
export const ModalConfirmationPayment = (props) => {

    log.info("[ModalConfirmationPayment] Rendering ModalConfirmationPayment Component...")
    const renderModalConfirmationPayment = () => {
        return (
            <Grid container direction="column">
                ...
                <Grid item container alignItems="center" style={{textAlignLast: "center"}}>
                    <Grid item xs={6} onClick={props.removeConfirmedHandler} style={{
                        color: "blue", fontWeight: "bold", cursor: "pointer"
                    }}>
                        Pay
                    </Grid>
    ...
    return (
        <Modal renderWarningComponent={renderModalConfirmationPayment()}
               modalWidth="300px"
