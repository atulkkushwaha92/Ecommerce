...
import {SHOPIT_PRODUCT_INFO_COOKIE} from "../../../constants/cookies";
...
function ProductDetails(props) {
    ...
    const dispatchAddToCart = newAddToCart => {
        Cookies.set(SHOPIT_PRODUCT_INFO_COOKIE, newAddToCart, {expires: 7});
        ...
        <>
            ...
            <Grid container>
                ...
                <Grid item xs={11} sm={5} md={6} container direction={"column"} spacing={2}
					...
					<Grid item style={{fontSize: "1rem", fontWeight: 200}}>
