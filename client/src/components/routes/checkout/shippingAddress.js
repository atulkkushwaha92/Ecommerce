    ...
    render() {
        ...
        const renderShippingSummaryAddresses = () => {
            ...
            let contentList = [
                ...
                `${formValues.city}, ${formValues.pinCode}`,
                formValues.email,
                        ...
                        <form onSubmit={this.handleSubmit} className={classes.root}
                            ...
                            <Grid item container xs={11} sm={8}>
                                <Field
                                    ...
                                    props={{placeholder: "Flat#, Apartment Building Floor etc", shrink: true}}
                                />
                            </Grid>
							{renderFormTextField("Pin Code", "pinCode")}
                            ...
                            <Grid item container xs={11} sm={8}>
                                <Field
                                    ...
                                    component={renderReduxTextField}
                                    label="Phone Number"
                                    props={{placeholder: "9999999999", shrink: true}}
                                />
                            </Grid>
