    ...
    const handleRadioBtnChange = (event) => {
        ...
        switch (event.target.value) {
            case "free":
                ...
                break
            case "prime":
                deliveryPrice = deliveryPrices.prime
                break
            default:
        ...
        return (
            <FormControl component="fieldset" style={{width: "inherit"}}>
                <RadioGroup aria-label="delivery-option" name="delivery-option" value={shippingOptionState.value}
                    ...
                    <FormControlLabel value="prime" control={<Radio style={{marginLeft: 15}}/>}
                                      style={{width: "inherit", margin: "inherit"}}
                                      classes={{label: classes.formControlLabel}}
                                      label={renderRadioBtnLabel(shippingOptionsData.prime.label,
                                          shippingOptionsData.prime.transitLabel,
                                          shippingOptionsData.prime.price,
                                          shippingOptionsData.prime.estimatedDays)}/>
                </RadioGroup>
            </FormControl>
        )
    }
